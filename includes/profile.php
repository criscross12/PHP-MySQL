...
?>
    <?php
   $sql = "SELECT alumno.id as id,carrera.Nombre as NombreCarrera, alumno.Nombre as NombreAlumno,alumno.A_paterno as AP,semestre.Semestre as semestre,\n"
   . "alumno.A_Materno AS AM, alumno.Matricula AS matricula,alumno.Contrasena as contrasena FROM alumno 
   INNER join carrera on alumno.Carrera = carrera.id INNER JOIN semestre on semestre.id = alumno.semestre where alumno.id= $idUsuario";
