    ...
    <div class="col-md-8">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php
                $sql = "SELECT  materias.ID as id,carrera.Nombre as NC,semestre.Semestre as S, materias.Nombre AS NM 
                        FROM `materias` INNER JOIN semestre on semestre.id = materias.Semestre 
                        INNER JOIN carrera on carrera.id = materias.Carrera";
