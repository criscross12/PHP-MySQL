            ...
            <div class="col-sm-4">
                <form action="savealum.php" method="POST">
                    <div class="form-group">
                        <input type="text" name="nombre" class="form-control" placeholder="Nombre(s)" autofocus required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="AP" class="form-control" placeholder="Apellido Paterno" autofocus required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="AM" class="form-control" placeholder="Apellido Materno" autofocus required>
                    </div>
                    <div class="form-group">
                        <input type="text" name="matricula" class="form-control" placeholder="Matricula" autofocus required>
                    </div>
                    <div class="form-group">
                        <input type="password" name="contrasena" class="form-control" placeholder="Contraseña" autofocus required>
                    </div>
                    <div class="form-group">
                    ...
                    <input type="submit" class="btn  btn-outline-success btn-block" name="save" value="GUARDAR" onclick="return confirm('Esta seguro de que tus datos son correctos?');"> <span class="glyphicon glyphicon-trash" aria-hidden="true"></span> </a></td>
                    <br>
